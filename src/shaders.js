...
void main()
{
    ...
    vec3 offset = vec3(0.0, sin(timePositionValue) + cos(timePositionValue), 0.0) * 0.05;
...
const float shininessDampening = 10.0;
...
void main()
{
    ...
    vec3 specular = specularFactor * specularReflectivity * directionalLightColor;
